...
#ifndef WEAVRCOMPONENTS_SWIFT_H
#define WEAVRCOMPONENTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WeavrComponents",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15WeavrComponents18SecureCardPinField")
@interface SecureCardPinField : SecureTextField
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC15WeavrComponents18SecureCardPinLabel")
@interface SecureCardPinLabel : SecureLabel
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, copy) NSString * _Nullable text;
@end
...
@interface SecurePasscodeFieldStack (SWIFT_EXTENSION(WeavrComponents)) <UITextFieldDelegate>
...
SWIFT_CLASS("_TtC15WeavrComponents19SecurePasswordField")
@interface SecurePasswordField : SecureTextField
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
